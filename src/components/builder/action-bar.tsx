...
export function ActionBar({ wizardData }: ActionBarProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md supports-[backdrop-filter]:bg-background/80 border-t border-border/40 shadow-lg print:hidden">
